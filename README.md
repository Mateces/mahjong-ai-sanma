...
Download from [Releases](https://github.com/lynkas/c3/releases/tag/v1.0):
...
Training data uses `.mjson` format (gzipped JSON lines), where each file contains one game in [mjai](https://mjai.app/) event format. The dataloader (`scripts/dataloader.py`) handles parsing via `libriichi`.
